...
class WPO_Posts extends WPO_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('WPO Posts Widget', 'pharmacy'),
            // Widget description
            array( 'description' => __( '', 'pharmacy' ), )
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php echo __( 'Title:', 'pharmacy' ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'ids' ); ?>"><?php echo __( 'Posts:', 'pharmacy' ); ?></label>
            <br>
