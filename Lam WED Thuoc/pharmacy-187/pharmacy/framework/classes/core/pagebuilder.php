	...
	abstract class WPO_PageBuilder_Base{
		...
		private function setValueCssAnimationInput(){
			$this->cssAnimation = array(
									__("No", 'pharmacy') => '',
									__("Top to bottom", 'pharmacy') => "top-to-bottom",
									__("Bottom to top", 'pharmacy') => "bottom-to-top",
									__("Left to right", 'pharmacy') => "left-to-right",
									__("Right to left", 'pharmacy') => "right-to-left",
									__("Appear from center", 'pharmacy') => "appear",
									'bounce' => 'bounce',
									'flash' => 'flash',
									'pulse' => 'pulse',
