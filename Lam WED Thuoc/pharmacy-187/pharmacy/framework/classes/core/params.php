				...
				switch ($option['type']) {
					...
					case 'sidebars':
						$sidebars = $GLOBALS['wp_registered_sidebars'];
			 			...
			 			$values['none'] = __('Select A Sidebar', 'pharmacy');
			...
			$output.='
				<div id="wpo-element-map">
					...
					<div class="vc_row-fluid googlefind">
						...
						<button class="button-primary find">'.__("Find", 'pharmacy').'</button>
					</div>

					<div class="row-fluid mapdetail">
						<div class="form-group">
							<label for="wpo_input_class">'.__('Latitude', 'pharmacy').'</label>
							<input name="lat" class="form-control wpo-latgmap" type="text" value="">
						</div>
						<div class="form-group">
							<label for="wpo_input_class">'.__('Longitude', 'pharmacy').'</label>
