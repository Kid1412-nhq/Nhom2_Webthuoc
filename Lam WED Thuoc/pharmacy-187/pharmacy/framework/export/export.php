...
class PbrThemer_Export {
	...
	public function export_wordpress_content(){
		...
		if ( !current_user_can('export') )
			wp_die(__('You do not have sufficient permissions to export the content of this site.', 'pharmacy'));

		/** Load WordPress export API */
		require_once( ABSPATH . 'wp-admin/includes/export.php' );
		$title = __('Export', 'pharmacy');
	...
	public function pbrthemer_admin_export() {
		...
		add_submenu_page( 'themes.php', __( 'WpOpal Export', 'pharmacy' ), esc_html__( 'WpOpal Export', 'pharmacy' ), 'manage_options', 'pbrthemer_options_export_page', array(
			&$this,
		...
		<div class="wrapper">
			<div class="content">
				<table class="form-table">
					<tbody>
					<tr>
						<td scope="row" width="150"><h2><?php esc_html_e( 'Export Wordpress Content', 'pharmacy' ); ?></h2></td>
					</tr>
					...
					<tr>
						<td scope="row" width="150"><h2><?php esc_html_e( 'Export Revolution Slider', 'pharmacy' ); ?></h2></td>
					</tr>
