	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php _e( 'Qty', 'pharmacy' ); ?></th>
				<th class="product-total"><?php _e( 'Totals', 'pharmacy' ); ?></th>
			</tr>
		</thead>
		<tfoot>
	...
	<ul class="payment_methods methods clear-list">
		<?php
			if ( ! empty( $available_gateways ) ) {
				...
				echo '<li>' . apply_filters( 'woocommerce_no_available_payment_methods_message', __( 'Sorry, it seems that there are no available payment methods for your location. Please contact us if you require assistance or wish to make alternate arrangements.', 'pharmacy' ) ) . '</li>';
			}
		?>
	</ul>
	<?php endif; ?>
