...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_revslider_element no-margin-bottom wpb_content_element' . $el_class, $this->settings['base'], $atts );
