<?php
	...
	class WPO_Shortcode_Sidebar extends WPO_Shortcode_Base{
		...
		public function getButton( $data=null ){
			$button = array(
				'icon'	 => 'sidebar',
				'title' => __( 'Sidebar Embeded' , 'pharmacy'),
				'desc'  => __( 'Embeded widgets in a sidebar' , 'pharmacy'),
				'name'  => $this->name
			);
			return $button;
		}
		...
		public function getOptions( ){
		    ...
		    $this->options[] = array(
		        'label' 	=> __('Sidebar', 'pharmacy'),
		        'id' 		=> 'sidebar',
		        'type' 		=> 'sidebars',
		        'explain'	=> __( 'Display all widgets on selected sidebar', 'pharmacy' )
	        );
