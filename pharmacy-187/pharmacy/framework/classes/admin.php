...
if(!class_exists('WPO_AdminTheme')){
	class WPO_AdminTheme{
		...
		public function adminLoadMenu(){
			...
			add_theme_page( $this->themeName.' | Megamenu', __("Megamenu Editor", 'pharmacy'), 'switch_themes', 'wpo_megamenu', array($this,'megaMenuPage') );
			if($is_vertical_menu){
				add_theme_page( $this->themeName.' | Megamenu', __("Megamenu Vertical", 'pharmacy'), 'switch_themes', 'wpo_megamenu_vertical', array($this,'megaMenuVerticalPage') );
			}
			add_theme_page( $this->themeName.' | Live Theme Editor ', __("Live Theme Editor", 'pharmacy'), 'switch_themes', 'wpo_livethemeedit', array($this,'liveThemePage') );
		}
