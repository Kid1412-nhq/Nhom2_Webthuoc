	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><?php echo __('Pattern Manager', 'pharmacy'); ?></h4>
			</div>
			<div class="modal-body">
				<span class="spinner"></span>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-xs btn-danger" data-dismiss="modal"><?php echo __('Close', 'pharmacy'); ?></button>
			</div>
		</div>
	</div>
</div>
		...
		<div class="wpo-customize" id="wpo-customize">
			<div class="wrapper">
				<div id="customize-form">
					...
					<p>
						<span class="badge">
							<?php echo __('Theme', 'pharmacy');?>: <?php echo 'pharmacy'; ?>
						</span>
						<?php 
							$url_back = '';
					...
					<div class="groups clearfix">
						<div class="form-group pull-left">
							<label><?php echo __('Css Profiles:', 'pharmacy'); ?></label>
						...
						<div class="form-group ">
							<label class="show-for-notexisted"><?php echo __('And Named This: ', 'pharmacy'); ?></label>
							<label class="show-for-existed"><?php echo __('And Rename To:', 'pharmacy'); ?></label>
												...
												<div class="accordion-inner panel-body clearfix">
													...
													<?php  if (isset($item['type'])&&$item['type']=="image") { ?>
														<div class="form-group background-images">
															...
															<p>
																<em style="font-size:10px"><?php echo __('Those Images in folder YOURTHEME/images/bg/', 'pharmacy') ?></em>
															</p>
													...
													<?php } elseif( $item['type'] == "fontsize" ) { ?>
														<div class="form-group">
															...
															<a href="#" class="clear-bg label label-success"><?php echo __('Clear', 'pharmacy'); ?></a>
														</div>
													<?php } else { ?>
														<div class="form-group">
															<label><?php echo $item['label']?></label>
