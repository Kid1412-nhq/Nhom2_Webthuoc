...
?>
<form method="post" class="login box" <?php if ( $hidden ) echo 'style="display:none;"'; ?>>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<label for="username"><?php _e( 'Username or email', 'pharmacy' ); ?> <span class="required">*</span></label>
